...
#         producer: VectorDocumentProducer,
...
#         self.service_name = "vector-document-service"
...
#                 print(
#                     f"[{self.service_name}] Failed to decode cached data for key {cache_key}. Invalidating cache."
#                 )
...
#             print(f"[{self.service_name}] Created documents with IDs: {document_ids}")
...
#             print(
#                 f"[{self.service_name}] Created document with ID: {document_id}, details: {document}"
#             )
...
#                 f"[{self.service_name}] Document with id: {document_id} not found."
#             )
