...
# # TODO: delete this after updating the vector document repository to use the QdrantService instead of the database
# # ! the valid version of this is in services/ingest-service/app/models/document.py
...
#         String(50), server_default=IngestStatus.STARTED
#     )
